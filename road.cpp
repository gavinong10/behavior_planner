...
void Road::advance() {
  /* For each of the vehicles on the road (generated randomly to match density), 
  get a vector of predictions for behavior. 
  
  Based on the predictions of all the vehicles, choose the next state of the vehicle. 
  
  *first* represents the integer id of a vehicle on the road. *second* is the actual vehicle.
  
  This function advances all vehicles based on the trajectory mapped by choose_next_state*/
